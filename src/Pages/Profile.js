...
{ editMode ?(<>
  ...
  <div className="mb-28 h-full">
        <div className="self-center text-center items-center justify-center flex">
          <div className="mr-5">
          ...
          <div className="float-right right-96 text-right text-xs absolute m-0 cursor-pointer text-gray-700" onClick={switchEditMode}>
            <Edit />
            Done
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div>
            ...
            <br /><textarea
                    ...
                    /><br/>
                      <button
                      className=" text-sm text-black bg-green-400 px-3 py-2 rounded"
                    >
                     Save Bio
                    </button>
          </div>
          <div className="float-right right-96 text-right text-base m-0 absolute text-gray-700">
            ...
            <br />
            Age:{" "}
            {Math.floor(moment().diff(currentUser.birthdate, "years", true))}
          </div>
        </div>{" "}
      </div>
